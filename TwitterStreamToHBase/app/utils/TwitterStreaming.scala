...
object TwitterStreaming {
  ...
  val sparkConf = new SparkConf().setAppName("TwitterStreaming").setMaster("local[10]").set("allowMultipleContexts", "true")
  ...
  def TwitterStreamUtil {
    ...
    topCounts60.foreachRDD(rdd => {
      ...
      CSVUtils.CSVUtils.createCSVFromArray(topList, headers, "/Users/rishikaidnani/Desktop/BigData/RealTime/PopularHashTags/PopularHashTags.csv")
    ...
    topMentions60.foreachRDD(rdd => {
      ...
      CSVUtils.CSVUtils.createCSVFromArray(topUserList, headers, "/Users/rishikaidnani/Desktop/BigData/RealTime/UserMentions/PopularUsers.csv")
